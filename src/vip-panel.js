    ...
    .addTextDisplayComponents(
      txt(
        [
          ...
          "",
          "**Шаг 3.** Напиши админам в Discord (тикет / этот канал):",
          "• «Оплатил VIP на Boosty»",
          "• свой Discord",
          "• SteamID64 **или** что уже сделал `/link`",
          "• по желанию — скрин оплаты",
          "",
          "**Шаг 4.** Админ выдаёт VIP командой",
          "Сразу включаются приоритет в очереди и роль Discord.",
          "",
